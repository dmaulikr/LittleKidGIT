...
#import "CheseTools.h"
//int ischessReverse;
int lenthOfUnitWidth;//  (int)(MAINSCREEN_WIDTH/9.14)

int lenthOfUnitHight;// (int)(MAINSCREEN_HEIGHT/14.4)

int lenthChesePieces;// lenthOfUnitHight

int widthChesePieces;// lenthOfUnitWidth

int chessboardStartPointy;// (int)(MAINSCREEN_HEIGHT/19.2)

int chessStartPointY;// (int)chessboardStartPointy*3
int chessStartPointX;
